...
pubDate: 2016-03-06T18:58:56+00:00
author: Oren Farhi
# templateKey: blog-post
layout: '@/templates/BasePost.astro'
# guidhttp://orizens.com/wp/?p=963
# permalink: /blog/angular-2-communication-between-components-components-design/
dsq_thread_id:
  - "4639629364"
imgSrc: /images/blog/2016/03/commucompo.jpg
tags:
  - angular2
  - architecture
  - ngrx
...
<a href="http://echoesplayer.netlify.app" target="_blank">Echoes Player</a> is an <a href="http://github.com/orizens/echoes" target="_blank">open source media player</a> (no ads included :-)) that plays videos from <a href="http://youtube.com" target="_blank">youtube</a> using its data api and the youtube iframe api. So, after adding the feature to play a video, the next feature in my list is to manage a playlist so I can play several videos in a sequence.

The orange area in the below screenshot is the now-playlist feature:

<img class="alignnone size-large wp-image-965" src="...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.59.50-PM-1024x640.png" alt="Screen Shot 2016-03-06 at 5.59.50 PM" width="697" height="436" srcset="...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.59.50-PM-1024x640.png 1024w, ...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.59.50-PM-300x188.png 300w, ...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.59.50-PM-768x480.png 768w" sizes="(max-width: 697px) 100vw, 697px" />
...
<img class="alignnone size-full wp-image-966" src="...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.51.52-PM.png" alt="Screen Shot 2016-03-06 at 5.51.52 PM" width="604" height="904" srcset="...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.51.52-PM.png 604w, ...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.51.52-PM-200x300.png 200w, ...//images/blog/2016/03/Screen-Shot-2016-03-06-at-5.51.52-PM-300x449.png 300w" sizes="(max-width: 604px) 100vw, 604px" />
