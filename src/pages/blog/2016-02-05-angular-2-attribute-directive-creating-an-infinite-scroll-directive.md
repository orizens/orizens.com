...
pubDate: 2016-02-05T10:25:01+00:00
author: Oren Farhi 
# templateKey: blog-post
layout: '@/templates/BasePost.astro'
# guidhttp://orizens.com/wp/?p=939
# permalink: /blog/angular-2-attribute-directive-creating-an-infinite-scroll-directive/
dsq_thread_id:
  - "4553592304"
imgSrc: /images/blog/2016/02/scroll.jpg
tags:
  - angular2
  - es2015
  - typescript
...
In the current production of <a href="http://echoesplayer.netlify.app" target="_blank">Echoes Player</a>, in order to add more videos to the result while scrolling, I used "<a href="https://sroze.github.io/ngInfiniteScroll/" target="_blank">ng-infinite-scroll</a>". It has a nice minimal directive api for triggering an infinite scroll - and the usage for Echoes Player is quite simple:
